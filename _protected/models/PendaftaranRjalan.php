 ...
 * @property AUnit $kodePoli
 * @property ARefcarapulangdtl $kodeSubPlg
 * @property BPendaftaranRjalanTindakan[] $bPendaftaranRjalanTindakans
 */
class PendaftaranRjalan extends SimrsModel
{
    ...
    public function rules()
    {
        return [
            ...
            [['KodePoli'], 'exist', 'skipOnError' => true, 'targetClass' => AUnit::className(), 'targetAttribute' => ['KodePoli' => 'KodeUnit']],
            [['KodeSubPlg'], 'exist', 'skipOnError' => true, 'targetClass' => ARefcarapulangdtl::className(), 'targetAttribute' => ['KodeSubPlg' => 'KodeSub']],
        ];
    }
    ...
    {
        return $this->hasOne(AUnit::className(), ['KodeUnit' => 'KodePoli']);
    }

    /**
     * @return \yii\db\ActiveQuery
     */
    public function getKodeSubPlg()
    {
        return $this->hasOne(ARefcarapulangdtl::className(), ['KodeSub' => 'KodeSubPlg']);
    }

    /**
     * @return \yii\db\ActiveQuery
     */
    public function getBPendaftaranRjalanTindakans()
    {
        return $this->hasMany(BPendaftaranRjalanTindakan::className(), ['b_pendaftaran_rjalan_id' => 'Id']);
    }
}

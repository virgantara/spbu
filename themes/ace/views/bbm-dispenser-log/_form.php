...
$listDispenser = \app\models\BbmDispenser::getListDispensers();
...
<div class="bbm-dispenser-log-form">
    ...
    <?= $form->field($model, 'dispenser_id',['options'=>['class'=>'col-xs-12 col-lg-12']])->dropDownList($listDispenser, ['prompt'=>'.. Pilih Dispenser']); ?>
